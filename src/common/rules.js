export const rules = [
  ...
  { name: 'V2EX', domain: 'v2ex.com', length: 64 },
  { name: 'wallets', domain: 'wallets', length: 32 },
  ...
  { name: 'LobeChat', domain: 'LobeChat', length: 32 },
  { name: 'NextChat', domain: 'NextChat', length: 32 },
]
